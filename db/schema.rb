...
ActiveRecord::Schema.define(version: 2019_03_24_004254) do
  ...
  create_table "homes", id: :serial, force: :cascade do |t|
    ...
    t.string "suburb"
    t.string "house_age"
    t.string "residents_ethnics", default: [], array: true
    t.boolean "residents_with_lgbtq", default: false, null: false
    t.boolean "residents_with_physical_disabled", default: false, null: false
    t.boolean "residents_with_respiratory_illness", default: false, null: false
    t.boolean "residents_with_allergies", default: false, null: false
    t.boolean "residents_with_depression", default: false, null: false
    t.boolean "residents_with_anxiety", default: false, null: false
    t.boolean "residents_with_children", default: false, null: false
    t.boolean "residents_with_elderly", default: false, null: false
